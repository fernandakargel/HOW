...
CREATE TABLE `role_has_skill` (
  ...
  KEY `fk_role_has_skill_skill1_idx` (`skill`),
  KEY `fk_role_has_skill_role1_idx` (`role`),
  CONSTRAINT `fk_role_has_skill_role1` FOREIGN KEY (`role`) REFERENCES `role` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_role_has_skill_skill1` FOREIGN KEY (`skill`) REFERENCES `skill` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
