...
INSERT INTO `menu` (`id`,`name`,`label`,`url`,`title`,`icon`,`parent`,`allow`,`display`,`order`,`commentary`) VALUES (NULL,'import','Inportador','/import','Importe informacoes para o sistema','ti-cloud-up',2,';manager;admin;',1,25,NULL);
#Company
...
#User
INSERT INTO `menu` (`id`,`name`,`label`,`url`,`title`,`icon`,`parent`,`allow`,`display`,`order`,`commentary`) VALUES (NULL,'users.list','Usuários','/users','Lista de usuários','fa-unlock-alt',1,';manager;admin;',2,9050,NULL);
